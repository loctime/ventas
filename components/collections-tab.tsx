...
export function CollectionsTab() {
  ...
  const { addCollection, paymentMethods, loading, error } = useFirestoreCashflow()
  ...
  const handleSubmit = async (amount: number, note?: string) => {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-2xl font-bold text-balance">Registrar Cobro</h2>
      <p className="text-muted-foreground text-pretty">Selecciona un método de pago para registrar un ingreso</p>
